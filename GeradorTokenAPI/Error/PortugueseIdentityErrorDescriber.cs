...
namespace GeradorDeTokenAPI.Error
{
    public class PortugueseIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric() { return new IdentityError { Code = nameof(PasswordRequiresNonAlphanumeric), Description = "Senhas devem conter ao menos um caracter não alfanumérico como estes (@,#,_,- e !)." }; }
        ...
        public override IdentityError PasswordRequiresLower() { return new IdentityError { Code = nameof(PasswordRequiresLower), Description = "Senhas devem conter ao menos uma letra minuscula ('a'-'z')." }; }
